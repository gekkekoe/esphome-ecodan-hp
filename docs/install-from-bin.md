...
* Configure WiFi in https://web.esphome.io/?dashboard_install: If you have a recent firmware you can set the WiFi credentials via the three-dots menu / Configure WiFi / Change WiFi. You can skip the next step if the WiFi is configured this way (wait for the led indicator to become blue). 
