...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional("sw_legionella_dhw_automation_id"):    cv.use_id(switch.Switch),
        cv.Optional("num_legionella_dhw_setpoint_id"):     cv.use_id(number.Number),
        cv.Optional("legionella_saved_dhw_setpoint_id"):   cv.use_id(globals.GlobalsComponent),
        ...
        cv.Optional("num_raw_heat_produced_z2_id"):        cv.use_id(number.Number),
        cv.Optional("num_raw_elec_consumed_z2_id"):        cv.use_id(number.Number),
        cv.Optional("num_raw_runtime_hours_z2_id"):        cv.use_id(number.Number),
        cv.Optional("num_raw_avg_room_temp_z2_id"):        cv.use_id(number.Number),
        cv.Optional("num_raw_delta_room_temp_z2_id"):      cv.use_id(number.Number),
        ...
        cv.Optional("num_raw_cool_produced_z2_id"):        cv.use_id(number.Number),
        cv.Optional("num_raw_cool_elec_consumed_z2_id"):   cv.use_id(number.Number),
        cv.Optional("num_raw_cool_runtime_hours_z2_id"):   cv.use_id(number.Number),
        cv.Optional("num_raw_cool_avg_room_temp_z2_id"):   cv.use_id(number.Number),
...
async def to_code(config):
    ...
    pairs = [
        ...
        ("sw_legionella_dhw_automation_id",   "set_sw_legionella_dhw_automation"),
        ("num_legionella_dhw_setpoint_id",    "set_num_legionella_dhw_setpoint"),
        ("legionella_saved_dhw_setpoint_id",  "set_legionella_saved_dhw_setpoint"),
        ...
        ("num_raw_heat_produced_z2_id",       "set_num_raw_heat_produced_z2"),
        ("num_raw_elec_consumed_z2_id",       "set_num_raw_elec_consumed_z2"),
        ("num_raw_runtime_hours_z2_id",       "set_num_raw_runtime_hours_z2"),
        ("num_raw_avg_room_temp_z2_id",       "set_num_raw_avg_room_temp_z2"),
        ("num_raw_delta_room_temp_z2_id",     "set_num_raw_delta_room_temp_z2"),
        ...
        ("num_raw_cool_produced_z2_id",       "set_num_raw_cool_produced_z2"),
        ("num_raw_cool_elec_consumed_z2_id",  "set_num_raw_cool_elec_consumed_z2"),
        ("num_raw_cool_runtime_hours_z2_id",  "set_num_raw_cool_runtime_hours_z2"),
        ("num_raw_cool_avg_room_temp_z2_id",  "set_num_raw_cool_avg_room_temp_z2"),
