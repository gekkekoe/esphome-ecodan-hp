            ...
            if (is_heating_mode && is_heating_active)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        auto short_cycle_prevention_adjustment = isnan(mapped_pcp_old_flow_setpoint_) ? 0.0f : abs(mapped_pcp_old_flow_setpoint_ - this->get_flow_setpoint(optimizer_zone));
