...
{ 
        ...
        if (mode != ecodan::Status::HpMode::OFF) {
            ...
            switch (mode) {
                ...
                case ecodan::Status::HpMode::COOL_FLOW_TEMP:
                    if (set_cooling_mode != nullptr && this->mode != climate::ClimateMode::CLIMATE_MODE_COOL) {
                        set_cooling_mode();
    ...
    void EcodanClimate::control(const climate::ClimateCall &call) {
        ...
        if (get_current_temp != nullptr) {
            this->current_temperature = get_current_temp();
            should_publish = true;
        }
        ...
        if (call.get_target_temperature().has_value()) {
            ...
            if (set_target_temp != nullptr && temp != this->target_temperature) 
