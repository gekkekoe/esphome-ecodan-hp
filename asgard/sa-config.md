...
2.  Use the `Room Temp Source` selection box (`SETTINGS Z1 Section`) to select the room temperature source. `Choose Asgard virtual thermostat` [7]
3.  Use the `Temp Sensor Source` selection box (`VIRTUAL THERMOSTAT Z1 Section`) to select the temperature sensor source for the virtual thermostat. [4]
